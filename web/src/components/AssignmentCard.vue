...
<template>
  <Card
    class="assignment-card group cursor-pointer overflow-hidden bg-card transition-[transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:surface-lifted"
    role="button"
    tabindex="0"
    @click="emit('open')"
