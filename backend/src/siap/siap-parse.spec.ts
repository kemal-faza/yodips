...
describe('parseApiProfile', () => {
  it('maps data_mahasiswa + semester_aktif into SiapProfile', () => {
    const data = {
      ...
      tahun_masuk: '2024',
      tempat_lahir: 'KOTA UJI',
      tanggal_lahir: '2000-01-01',
      nik: '000000 000000 0000',
      nama_ibu: 'IBU UJI',
      sso_email: 'anonim.sso@students.undip.ac.id',
...
describe('parseKhsDetailIds', () => {
      ...
      <tbody>
        <tr>
          ...
          <td style="position: relative;">A
            <i class="fa fa-info-circle get_detail_khs"
               data-id="10622041#24060121130000#460110"
        ...
        <tr>
          ...
          <td style="position: relative;">AB
            <i class="fa fa-info-circle get_detail_khs"
               data-id="10622042#24060121130000#460149"></i>
          </td>
          <td>3.5</td><td>7</td>
        </tr>
      </tbody>
  ...
  it('maps kode → full data-id (id#nim#kode) from .get_detail_khs icons', () => {
    expect(parseKhsDetailIds(html)).toEqual([
      { kode: 'MIK1624203', detailId: '10622041#24060121130000#460110' },
      { kode: 'MIK1624204', detailId: '10622042#24060121130000#460149' },
    ]);
  });
...
describe('mergeKhsDetailIds', () => {
  it('attaches detailId by kode without clobbering id/others; keeps no-match entries', () => {
    ...
    expect(merged[0].detailId).toBe('10622041#24060121130000#460110');
    expect(merged[1].detailId).toBe('10622042#24060121130000#460149');
  ...
  it('drops a detailId whose leading id_irs segment does not match the API row id', () => {
    ...
    const merged = mergeKhsDetailIds(nilai, [
      ...
      { kode: 'MIK1624203', detailId: '99999999#24060121130000#460110' },
    ]);
